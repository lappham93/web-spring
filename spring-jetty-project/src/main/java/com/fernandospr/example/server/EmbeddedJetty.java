...
public class EmbeddedJetty {
    ...
    private static ServletContextHandler getServletContextHandler() throws IOException {
        ...
        ClassPathResource resources = new ClassPathResource(WEBAPP_DIRECTORY);
        System.out.println(resources.getURI());
        contextHandler.setResourceBase(resources.getURI().toString());        
